...
export const modalRequest = document.querySelector('.modal--request');
export const modalConsult = document.querySelector('.modal--consult');

export const modalBody = document.querySelector('.modal__body');
export const btnClose = document.querySelector('.modal__close');
export const buttonsRequest = document.querySelectorAll('.button--request');
export const buttonsConsult = document.querySelectorAll('.button--consult');
